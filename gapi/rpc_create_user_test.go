...
import (
	...
	mockdb "github.com/LinggaWahyu/Golang-Simple-Bank/db/mock"
	...
	mockwk "github.com/LinggaWahyu/Golang-Simple-Bank/worker/mock"
	...
	}{
		{
			...
			buildStubs: func(store *mockdb.MockStore, taskDistributor *mockwk.MockTaskDistributor) {
				...
				taskDistributor.EXPECT().
					DistributorTaskSendVerifyEmail(gomock.Any(), taskPayload, gomock.Any()).
					Times(1).
					Return(nil)
			},
			checkResponse: func(t *testing.T, res *pb.CreateUserResponse, err error) {
